...
paste("(BLR_Zhu_X) Percentage Bias: ", percentage_bias_BLR)
...
paste("(BLR_Zhu_X) Credible Interval Coverage: ", credible_interval_coverage_BLR)

# RMSE
BLR_RMSE <- sqrt(mean((est_ATE - true_ATE_Zhu_2023)^2))
paste("(BLR_Zhu_X) RMSE: ", BLR_RMSE)

# MCSE
MCSE <- sd(est_ATE)
paste("(BLR_Zhu_X) MCSE: ", MCSE)

# AESE
AESE <- mean(sd_ATE)
paste("(BLR_Zhu_X) AESE: ", AESE)
