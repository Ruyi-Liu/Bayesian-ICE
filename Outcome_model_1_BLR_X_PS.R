...
# Percentage Bias
bias_BLR <- mean(est_ATE)-true_ATE_Linear
percentage_bias_BLR <- abs(bias_BLR/true_ATE_Linear)
paste("(BLR_Linear_X_PS) Percentage Bias: ", percentage_bias_BLR)
...
paste("(BLR_Linear_X_PS) Credible Interval Coverage: ", credible_interval_coverage_BLR)

# RMSE
BLR_RMSE <- sqrt(mean((est_ATE - true_ATE_Linear)^2))
paste("(BLR_Linear_X_PS) RMSE: ", BLR_RMSE)

# MCSE
MCSE <- sd(est_ATE)
paste("(BLR_Linear_X_PS) MCSE: ", MCSE)

# AESE
AESE <- mean(sd_ATE)
paste("(BLR_Linear_X_PS) AESE: ", AESE)
