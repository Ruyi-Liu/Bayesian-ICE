...
# Percentage Bias
bias_BART <- mean(est_ATE)-true_ATE_Tan_2019
percentage_bias_BART <- abs(bias_BART/true_ATE_Tan_2019)
paste("(BART_Tan_X_PS) Percentage Bias: ", percentage_bias_BART)
...
paste("(BART_Tan_X_PS) Credible Interval Coverage: ", credible_interval_coverage_BART)

# RMSE
BART_RMSE <- sqrt(mean((est_ATE - true_ATE_Tan_2019)^2))
paste("(BART_Tan_X_PS) RMSE: ", BART_RMSE)

# MCSE
MCSE <- sd(est_ATE)
paste("(BART_Tan_X_PS) MCSE: ", MCSE)

# AESE
AESE <- mean(sd_ATE)
paste("(BART_Tan_X_PS) AESE: ", AESE)
