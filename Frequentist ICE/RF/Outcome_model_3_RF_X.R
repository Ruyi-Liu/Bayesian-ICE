...
paste("(freq_RF_Tan_X) Percentage Bias: ", percentage_bias_RF)

# MCSD
MCSD <- sd(est_ATE)
paste("(freq_RF_Tan_X) MCSD: ", MCSD)

# RMSE
RF_RMSE <- sqrt(mean((est_ATE - true_ATE_Tan)^2))
paste("(freq_RF_Tan_X) RMSE: ", RF_RMSE)
...
paste("(freq_RF_Tan_X) Credible Interval Coverage: ", credible_interval_coverage_RF)
