...
# Percentage Bias
bias_RF <- mean(est_ATE)-true_ATE_Zhu
percentage_bias_RF <- abs(bias_RF/true_ATE_Zhu)
paste("(freq_RF_Zhu_X_PS) Percentage Bias: ", percentage_bias_RF)

# MCSD
MCSD <- sd(est_ATE)
paste("(freq_RF_Zhu_X_PS) MCSD: ", MCSD)

# RMSE
RF_RMSE <- sqrt(mean((est_ATE - true_ATE_Zhu)^2))
paste("(freq_RF_Zhu_X_PS) RMSE: ", RF_RMSE)
...
paste("(freq_RF_Zhu_X_PS) Credible Interval Coverage: ", credible_interval_coverage_RF)
