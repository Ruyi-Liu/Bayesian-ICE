...
paste("(freq_RF_Zhu_X) Percentage Bias: ", percentage_bias_RF)

# MCSD
MCSD <- sd(est_ATE)
paste("(freq_RF_Zhu_X) MCSD: ", MCSD)

# RMSE
RF_RMSE <- sqrt(mean((est_ATE - true_ATE_Zhu)^2))
paste("(freq_RF_Zhu_X) RMSE: ", RF_RMSE)
...
paste("(freq_RF_Zhu_X) Credible Interval Coverage: ", credible_interval_coverage_RF)
