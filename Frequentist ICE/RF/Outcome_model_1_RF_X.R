...
paste("(freq_RF_Linear_X) Percentage Bias: ", percentage_bias_RF)

# MCSD
MCSD <- sd(est_ATE)
paste("(freq_RF_Linear_X) MCSD: ", MCSD)

# RMSE
RF_RMSE <- sqrt(mean((est_ATE - true_ATE_Linear)^2))
paste("(freq_RF_Linear_X) RMSE: ", RF_RMSE)
...
paste("(freq_RF_Linear_X) Credible Interval Coverage: ", credible_interval_coverage_RF)
