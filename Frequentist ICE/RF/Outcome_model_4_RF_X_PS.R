...
paste("(freq_RF_Hu_X_PS) Percentage Bias: ", percentage_bias_RF)

# MCSD
MCSD <- sd(est_ATE)
paste("(freq_RF_Hu_X_PS) MCSD: ", MCSD)

# RMSE
RF_RMSE <- sqrt(mean((est_ATE - true_ATE_Hu)^2))
paste("(freq_RF_Hu_X_PS) RMSE: ", RF_RMSE)
...
paste("(freq_RF_Hu_X_PS) Credible Interval Coverage: ", credible_interval_coverage_RF)
