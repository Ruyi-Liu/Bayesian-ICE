...
paste("(freq_spline_Zhu_X ) Percentage Bias: ", percentage_bias_Bspline)

# MCSD
MCSD <- sd(est_ATE)
paste("(freq_spline_Zhu_X ) MCSD: ", MCSD)

# RMSE
Bspline_RMSE <- sqrt(mean((est_ATE - true_ATE_Zhu)^2))
paste("(freq_spline_Zhu_X ) RMSE: ", Bspline_RMSE)
...
paste("(freq_spline_Zhu_X ) Credible Interval Coverage: ", credible_interval_coverage_Bspline)
