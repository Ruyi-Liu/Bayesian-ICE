...
paste("(freq_spline_Tan_X ) Percentage Bias: ", percentage_bias_Bspline)

# MCSD
MCSD <- sd(est_ATE)
paste("(freq_spline_Tan_X ) MCSD: ", MCSD)

# RMSE
Bspline_RMSE <- sqrt(mean((est_ATE - true_ATE_Tan)^2))
paste("(freq_spline_Tan_X ) RMSE: ", Bspline_RMSE)
...
paste("(freq_spline_Tan_X ) Credible Interval Coverage: ", credible_interval_coverage_Bspline)
