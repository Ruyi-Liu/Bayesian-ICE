...
paste("(freq_spline_Linear_X ) Percentage Bias: ", percentage_bias_Bspline)

# MCSD
MCSD <- sd(est_ATE)
paste("(freq_spline_Linear_X ) MCSD: ", MCSD)

# RMSE
Bspline_RMSE <- sqrt(mean((est_ATE - true_ATE_Linear)^2))
paste("(freq_spline_Linear_X ) RMSE: ", Bspline_RMSE)
...
paste("(freq_spline_Linear_X ) Credible Interval Coverage: ", credible_interval_coverage_Bspline)
...
# AESE
#AESE <- mean(sd_ATE)
#paste("(freq_spline_Linear_X ) AESE: ", AESE)
