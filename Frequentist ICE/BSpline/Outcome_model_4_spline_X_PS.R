...
paste("(freq_spline_Hu_X_PS) Percentage Bias: ", percentage_bias_Bspline)

# MCSD
MCSD <- sd(est_ATE)
paste("(freq_spline_Hu_X_PS) MCSD: ", MCSD)

# RMSE
Bspline_RMSE <- sqrt(mean((est_ATE - true_ATE_Hu)^2))
paste("(freq_spline_Hu_X_PS) RMSE: ", Bspline_RMSE)
...
paste("(freq_spline_Hu_X_PS) Credible Interval Coverage: ", credible_interval_coverage_Bspline)
