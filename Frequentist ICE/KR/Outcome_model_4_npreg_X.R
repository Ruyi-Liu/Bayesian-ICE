...
paste("(freq_npreg_Hu_X) Percentage Bias: ", percentage_bias_npreg)

# MCSD
MCSD <- sd(est_ATE)
paste("(freq_npreg_Hu_X) MCSD: ", MCSD)

# RMSE
npreg_RMSE <- sqrt(mean((est_ATE - true_ATE_Hu)^2))
paste("(freq_npreg_Hu_X) RMSE: ", npreg_RMSE)


#credible_interval_coverage_npreg <- coverage_num/M
#paste("(freq_npreg_Hu_X) Credible Interval Coverage: ", credible_interval_coverage_npreg)
