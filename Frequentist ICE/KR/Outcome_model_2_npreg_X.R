...
paste("(freq_npreg_Zhu_X) Percentage Bias: ", percentage_bias_npreg)

# MCSD
MCSD <- sd(est_ATE)
paste("(freq_npreg_Zhu_X) MCSD: ", MCSD)

# RMSE
npreg_RMSE <- sqrt(mean((est_ATE - true_ATE_Zhu)^2))
paste("(freq_npreg_Zhu_X) RMSE: ", npreg_RMSE)


#credible_interval_coverage_npreg <- coverage_num/M
#paste("(freq_npreg_Zhu_X) Credible Interval Coverage: ", credible_interval_coverage_npreg)
