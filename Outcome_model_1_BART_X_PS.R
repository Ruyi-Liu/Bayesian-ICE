...
# Percentage Bias
bias_BART <- mean(est_ATE)-true_ATE_Linear
percentage_bias_BART <- abs(bias_BART/true_ATE_Linear)
paste("(BART_Linear_X_PS) Percentage Bias: ", percentage_bias_BART)
...
paste("(BART_Linear_X_PS) Credible Interval Coverage: ", credible_interval_coverage_BART)

# RMSE
BART_RMSE <- sqrt(mean((est_ATE - true_ATE_Linear)^2))
paste("(BART_Linear_X_PS) RMSE: ", BART_RMSE)

# MCSE
MCSE <- sd(est_ATE)
paste("(BART_Linear_X_PS) MCSE: ", MCSE)

# AESE
AESE <- mean(sd_ATE)
paste("(BART_Linear_X_PS) AESE: ", AESE)
