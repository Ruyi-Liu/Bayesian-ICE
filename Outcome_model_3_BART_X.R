...
paste("(BART_Tan_X) Percentage Bias: ", percentage_bias_BART)
...
paste("(BART_Tan_X) Credible Interval Coverage: ", credible_interval_coverage_BART)

# RMSE
BART_RMSE <- sqrt(mean((est_ATE - true_ATE_Tan_2019)^2))
paste("(BART_Tan_X) RMSE: ", BART_RMSE)

# MCSE
MCSE <- sd(est_ATE)
paste("(BART_Tan_X) MCSE: ", MCSE)

# AESE
AESE <- mean(sd_ATE)
paste("(BART_Tan_X) AESE: ", AESE)
