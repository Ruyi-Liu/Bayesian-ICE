...
paste("(BART_Zhu_X_PS) Percentage Bias: ", percentage_bias_BART)
...
paste("(BART_Zhu_X_PS) Credible Interval Coverage: ", credible_interval_coverage_BART)

# RMSE
BART_RMSE <- sqrt(mean((est_ATE - true_ATE_Zhu_2023)^2))
paste("(BART_Zhu_X_PS) RMSE: ", BART_RMSE)

# MCSE
MCSE <- sd(est_ATE)
paste("(BART_Zhu_X_PS) MCSE: ", MCSE)

# AESE
AESE <- mean(sd_ATE)
paste("(BART_Zhu_X_PS) AESE: ", AESE)
