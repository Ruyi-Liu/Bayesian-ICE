...
paste("(BLR_Tan_X) Percentage Bias: ", percentage_bias_BLR)
...
paste("(BLR_Tan_X) Credible Interval Coverage: ", credible_interval_coverage_BLR)

# RMSE
BLR_RMSE <- sqrt(mean((est_ATE - true_ATE_Tan_2019)^2))
paste("(BLR_Tan_X) RMSE: ", BLR_RMSE)

# MCSE
MCSE <- sd(est_ATE)
paste("(BLR_Tan_X) MCSE: ", MCSE)

# AESE
AESE <- mean(sd_ATE)
paste("(BLR_Tan_X) AESE: ", AESE)
