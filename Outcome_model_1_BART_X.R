...
paste("(BART_Linear_X) Percentage Bias: ", percentage_bias_BART)
...
paste("(BART_Linear_X) Credible Interval Coverage: ", credible_interval_coverage_BART)

# RMSE
BART_RMSE <- sqrt(mean((est_ATE - true_ATE_Linear)^2))
paste("(BART_Linear_X) RMSE: ", BART_RMSE)

# MCSE
MCSE <- sd(est_ATE)
paste("(BART_Linear_X) MCSE: ", MCSE)

# AESE
AESE <- mean(sd_ATE)
paste("(BART_Linear_X) AESE: ", AESE)
