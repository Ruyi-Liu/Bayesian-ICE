...
paste("(BART_Hu_X) Percentage Bias: ", percentage_bias_BART)
...
paste("(BART_Hu_X) Credible Interval Coverage: ", credible_interval_coverage_BART)

# RMSE
BART_RMSE <- sqrt(mean((est_ATE - true_ATE_Hu_2021)^2))
paste("(BART_Hu_X) RMSE: ", BART_RMSE)

# MCSE
MCSE <- sd(est_ATE)
paste("(BART_Hu_X) MCSE: ", MCSE)

# AESE
AESE <- mean(sd_ATE)
paste("(BART_Hu_X) AESE: ", AESE)
